...
-- @param key string used for lookup of cached value
-- @param func callback used for construction of value
...
function Cache:__call( key, func, ... )
	...
	if not result[1] then
		error( result[2], 2 ) -- should not pass this – early return
	end
...
-- @param ... varargs, typically a single table, for options (optional)
-- @return self
function Cache.create( ... )
...
-- @param opts table for options (optional)
-- @return self
